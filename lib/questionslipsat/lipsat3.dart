...
import 'package:devoraquiz/questionslipsat/lipsat4.dart';

// ignore: must_be_immutable
class LIPSAT3 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPSAT3({Key? key}) : super(key: key);

  @override
  State<LIPSAT3> createState() => _LIPSAT3State();
}

class _LIPSAT3State extends State<LIPSAT3> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1Ze3HfH3nJk9dkr3e90UExh2asplPr3uC');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Essa tarde preparei uma fornada com 16 pães de queijo (25g). Comi 8 deles com meus amigos. E agora: quantos cubinhos de gordura saturada consumi nessa refeição?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LIPSAT4()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
