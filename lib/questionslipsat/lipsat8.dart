...
import 'package:devoraquiz/questionslipsat/lipsat9.dart';

// ignore: must_be_immutable
class LIPSAT8 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPSAT8({Key? key}) : super(key: key);

  @override
  State<LIPSAT8> createState() => _LIPSAT8State();
}

class _LIPSAT8State extends State<LIPSAT8> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1dLgEcOe_Jx2BmnUDaJ9TU-bvBpncTVv6');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'No café da tarde comi 10 bolachas de água e sal com café preto. Quantos gramas de gordura trans eu comi nesse lanchinho?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LIPSAT9()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
