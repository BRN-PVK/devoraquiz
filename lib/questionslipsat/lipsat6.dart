...
import 'package:devoraquiz/questionslipsat/lipsat7.dart';

// ignore: must_be_immutable
class LIPSAT6 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPSAT6({Key? key}) : super(key: key);

  @override
  State<LIPSAT6> createState() => _LIPSAT6State();
}

class _LIPSAT6State extends State<LIPSAT6> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1KiXss_CAcg2Ow4a9cVsNlGAFRe354hoH');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Ontem foi o dia do cachorro quente na escola: pão hot dog,  salsicha, catchup, mostarda, maionese, milho, ervilha, purê de batata, molho vinagrete e batata palha. Que delícia! Mas, quantos cubinhos de gordura saturada tinha nesta delícia?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LIPSAT7()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
