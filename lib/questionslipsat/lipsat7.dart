...
import 'package:devoraquiz/questionslipsat/lipsat8.dart';

// ignore: must_be_immutable
class LIPSAT7 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPSAT7({Key? key}) : super(key: key);

  @override
  State<LIPSAT7> createState() => _LIPSAT7State();
}

class _LIPSAT7State extends State<LIPSAT7> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1T5GsmptooStdMnxzNJVA8uGurpnbLVdD');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Hoje é dia de comer pastel na feira. Escolhi o pastel c/ recheio de frango, queijo e milho do Seu Jonas. Quantos cubinhos de gordura saturada tem nesse pastel?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LIPSAT8()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
