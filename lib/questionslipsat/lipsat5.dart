...
import 'package:devoraquiz/questionslipsat/lipsat6.dart';

// ignore: must_be_immutable
class LIPSAT5 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPSAT5({Key? key}) : super(key: key);

  @override
  State<LIPSAT5> createState() => _LIPSAT5State();
}

class _LIPSAT5State extends State<LIPSAT5> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1eiNybnMdUwG16tvlYsZdZvwJsKI0CYn0');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Hoje comi um misto quente com margarina, presunto e queijo muçarela. Acho que vai segurar até o almoço. Mas, quantos cubinhos de gordura saturada tem nesse lanche?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LIPSAT6()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
