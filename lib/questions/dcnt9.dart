...
import 'package:devoraquiz/questions/dcnt10.dart';
...
class DCNT9 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  DCNT9({Key? key}) : super(key: key);

  @override
  State<DCNT9> createState() => _DCNT9State();
}

class _DCNT9State extends State<DCNT9> {
          ...
          children: [
            ...
            InkWell(
              ...
              child: Container(
                ...
                margin: EdgeInsets.symmetric(horizontal: 17, vertical: 5),
                child: Text(
                  "B. Eu trabalho parado o dia todo",
                  style: TextStyle(
                      fontSize: 17,
                      fontWeight: FontWeight.bold,
                      color: Colors.white),
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => DCNT10()));
              },
              child: Container(
                width: MediaQuery.of(context).size.width,
                decoration: BoxDecoration(
