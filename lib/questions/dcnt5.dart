...
import 'package:devoraquiz/questions/dcnt6.dart';
...
class DCNT5 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  DCNT5({Key? key}) : super(key: key);

  @override
  State<DCNT5> createState() => _DCNT5State();
}

class _DCNT5State extends State<DCNT5> {
        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Como é seu ambiente de trabalho/escolar no dia a dia',
                style: TextStyle(fontSize: 25),
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => DCNT6()));
              },
              child: Container(
                width: MediaQuery.of(context).size.width,
                decoration: BoxDecoration(
