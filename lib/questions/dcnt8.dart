...
import 'package:devoraquiz/questions/dcnt9.dart';
...
class DCNT8 extends StatefulWidget {
  ...
  @override
  State<DCNT8> createState() => _DCNT8State();
}

class _DCNT8State extends State<DCNT8> {
        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Ultimamente seu final de semana tem sido como?',
                style: TextStyle(fontSize: 25),
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  "A. Muito cansativo, pois trabalho",
                  style: TextStyle(
                      fontSize: 17,
                      fontWeight: FontWeight.bold,
                      color: Colors.white),
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => DCNT9()));
              },
              child: Container(
                width: MediaQuery.of(context).size.width,
                decoration: BoxDecoration(
