...
import 'package:devoraquiz/questions/dcnt4.dart';
...
class DCNT3 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  DCNT3({Key? key}) : super(key: key);

  @override
  State<DCNT3> createState() => _DCNT3State();
}

class _DCNT3State extends State<DCNT3> {
        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Com qual situção você mais se identifica ao se locomover?',
                style: TextStyle(fontSize: 25),
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => DCNT4()));
              },
              child: Container(
                width: MediaQuery.of(context).size.width,
                decoration: BoxDecoration(
