...
import 'package:devoraquiz/questions/dcnt5.dart';
...
class DCNT4 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  DCNT4({Key? key}) : super(key: key);

  @override
  State<DCNT4> createState() => _DCNT4State();
}

class _DCNT4State extends State<DCNT4> {
        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Com qual situção você mais se identifica ao almoçar?',
                style: TextStyle(fontSize: 25),
            ...
            InkWell(
              ...
              onLongPress: () {
                ...
                var upScore = db.collection('users').doc(useruid);
                upScore.update(
                  {"scoredcnt": FieldValue.increment(20)},
                );
              },
              child: Container(
                width: MediaQuery.of(context).size.width,
                ...
                margin: EdgeInsets.symmetric(horizontal: 17, vertical: 5),
                child: Text(
                  "C. arroz, feijão, proteína, legumes e verduras",
                  style: TextStyle(
                      fontSize: 17,
                      fontWeight: FontWeight.bold,
                      color: Colors.white),
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => DCNT5()));
              },
              child: Container(
                width: MediaQuery.of(context).size.width,
                decoration: BoxDecoration(
