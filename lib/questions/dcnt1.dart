...
class DCNT1 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  DCNT1({Key? key}) : super(key: key);

  @override
  State<DCNT1> createState() => _DCNT1State();
}

class _DCNT1State extends State<DCNT1> {
        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Com qual situção você mais se identifica ao acordar?',
                style: TextStyle(fontSize: 25),
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => DCNT2()));
              },
              child: Container(
                width: MediaQuery.of(context).size.width,
                decoration: BoxDecoration(
