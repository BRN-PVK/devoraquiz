...
import 'package:devoraquiz/questions/dcnt8.dart';
import '../pages/questionsLipIns.dart';

// ignore: must_be_immutable
class DCNT7 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  DCNT7({Key? key}) : super(key: key);

  @override
  State<DCNT7> createState() => _DCNT7State();
}

class _DCNT7State extends State<DCNT7> {
        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Seu sono tem seguido qual das alternativas?',
                style: TextStyle(fontSize: 25),
            ...
            InkWell(
              onTap: () {
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => DCNT8()));
              },
              child: Container(
                width: MediaQuery.of(context).size.width,
                decoration: BoxDecoration(
