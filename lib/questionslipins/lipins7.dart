...
import 'package:devoraquiz/pages/feedlipins.dart';
...
class LIPINS7 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPINS7({Key? key}) : super(key: key);

  @override
  State<LIPINS7> createState() => _LIPINS7State();
}

class _LIPINS7State extends State<LIPINS7> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1Kl5Sh87CpunBAO4fuEFsBChGw8rfRHl0');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Hoje vou receber uns amigos de infância. Vou preparar uma sobremesa que nos lembra da escola em que nos conhecemos. Essa receita vai 2 abacates maduros ( 300g) e 2 colheres de sopa de cacau em pó ( 30g) e açúcar ou melaço. Quantas porções de gordura insaturada terá essa sobremesa ?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                          builder: (context) => FeedbackLipIns(id!)));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
