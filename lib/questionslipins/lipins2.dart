...
import 'package:devoraquiz/questionslipins/lipins3.dart';
...
class LIPINS2 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPINS2({Key? key}) : super(key: key);

  @override
  State<LIPINS2> createState() => _LIPINS2State();
}

class _LIPINS2State extends State<LIPINS2> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=15VfyCo5WVd7ghqYSN9VTD0RJ37-23SHS');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Minha vó tem uma receita de macarrão deliciosa que vai 1 lata de sardinha. Quantas porções de gordura insaturada tem nesta latinha (170g)?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LIPINS3()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
