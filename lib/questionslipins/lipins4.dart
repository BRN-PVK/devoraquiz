...
import 'package:devoraquiz/questionslipins/lipins5.dart';
...
class LIPINS4 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPINS4({Key? key}) : super(key: key);

  @override
  State<LIPINS4> createState() => _LIPINS4State();
}

class _LIPINS4State extends State<LIPINS4> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1yRCLYPzJGipbZzeyZWfMk0QPEsT7_aDX');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Na casa da minha vó costumo lanchar meio abacate (100g) com 1 colher de sopa de sementes de linhaça (10g). Quantas porções de gordura insaturada tem neste lanche?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LIPINS5()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
