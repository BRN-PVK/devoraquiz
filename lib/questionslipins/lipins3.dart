...
import 'package:devoraquiz/questionslipins/lipins4.dart';
...
class LIPINS3 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPINS3({Key? key}) : super(key: key);

  @override
  State<LIPINS3> createState() => _LIPINS3State();
}

class _LIPINS3State extends State<LIPINS3> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1UnPDIAuq1lldTJ7k5wnVRtosN-NfAw0b');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Todo dia quando acordo tomo vitamina de abacate com meio copo americano da fruta (100g) e água. Quantas porções de gordura insaturada eu consumi?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LIPINS4()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
