...
import 'package:devoraquiz/questionslipins/lipins2.dart';
...
class LIPINS1 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  LIPINS1({Key? key}) : super(key: key);

  @override
  State<LIPINS1> createState() => _LIPINS1State();
}

class _LIPINS1State extends State<LIPINS1> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=13r2CG6Cqacq-_nqp6OuTXLqi54Gnj1Nr');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Fiz um sanduichão com 1 lata de atum ralado (170g) e ficou uma delícia. Quantas porções de gordura insaturada será que eu comi?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => LIPINS2()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
