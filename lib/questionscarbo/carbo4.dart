...
import 'package:devoraquiz/questionscarbo/carbo5.dart';
...
class CARBO4 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  CARBO4({Key? key}) : super(key: key);

  @override
  State<CARBO4> createState() => _CARBO4State();
}

class _CARBO4State extends State<CARBO4> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1swHbOWCrenKdvPuEsGtZY_5VYmAxncPC');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Que vontade de comer 01 pacote de bolachas recheadas do tipo wafer, sabor morango, todinho (18 unidades)! Comi 7 bolachas, que delícia! Quantos sachês de açúcar será que tinha aqui?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => CARBO5()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
