...
import 'package:devoraquiz/questionscarbo/carbo10.dart';
...
class CARBO9 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  CARBO9({Key? key}) : super(key: key);

  @override
  State<CARBO9> createState() => _CARBO9State();
}

class _CARBO9State extends State<CARBO9> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1iB3eOkWpr5IUMP_4JEhgJNAaYrW6Ksj2');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Todos os dias eu costumo tomar 02 copos (240ml) de refrigerante do tipo guaraná. Quantos pacotes de açúcar (1kg) será que consumi ao final do mês tomando este refrigerante?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => CARBO10()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
