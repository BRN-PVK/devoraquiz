...
import 'package:devoraquiz/questionscarbo/carbo3.dart';
...
class CARBO2 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  CARBO2({Key? key}) : super(key: key);

  @override
  State<CARBO2> createState() => _CARBO2State();
}

class _CARBO2State extends State<CARBO2> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1woyhnWGjsWUTIPINZOPjHEvurMaVJ2V2');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Adoro aquelas barrinhas de cereais! Comi 01 barrinha no meu lanche da escola. Quantos sachês de açúcar será que eu comi?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => CARBO3()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
