...
import 'package:devoraquiz/questionscarbo/carbo4.dart';
...
class CARBO3 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  CARBO3({Key? key}) : super(key: key);

  @override
  State<CARBO3> createState() => _CARBO3State();
}

class _CARBO3State extends State<CARBO3> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=1s5E2CLZnNlzI1q8cGlSDnlwgrMwrnHAu');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  'Hora do lanche de novo! Vou tomar 01 potinho de iogurte de morango (100ml). Quantos sachês de açúcar será que eu comi?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => CARBO4()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
