...
import 'package:devoraquiz/questionscarbo/carbo7.dart';
...
class CARBO6 extends StatefulWidget {
  late String questionsId;
  late String queQuestion;

  CARBO6({Key? key}) : super(key: key);

  @override
  State<CARBO6> createState() => _CARBO6State();
}

class _CARBO6State extends State<CARBO6> {
          ...
          child: Column(
            ...
            children: [
                        ...
                        onPressed: () async {
                          if (isPlaying) {
                            ...
                            await audioPlayer.play(
                                'https://docs.google.com/uc?export=download&id=12C-BzKrPq3ezdTEUMa0Ia_KMgfBN0FCa');
                          }
                        },
                      ),
                    )
              ...
              Container(
                ...
                child: Text(
                  ' Estava com muita fome e comi 02 barrinhas de cereal sabor banana. Quantos sachês de açúcar será que eu comi?',
              ...
              InkWell(
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => CARBO7()));
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
